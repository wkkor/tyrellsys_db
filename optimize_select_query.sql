        ...
        ALL (
            ...
            FROM
                ...
                LEFT JOIN affiliates Tools ON (
                    Tools.id = (JobsTools.affiliate_id)
                    AND Tools.type = 1
        ...
        ALL (
            ...
            FROM
                ...
                LEFT JOIN affiliates CareerPaths ON (
                    CareerPaths.id = (JobsCareerPaths.affiliate_id)
            ...
            WHERE
                (
                    ...
                    AND (Jobs.deleted) IS NULL
                    AND (
                        CareerPaths.name LIKE '%キャビンアテンダント%'
                    )
                )
            GROUP BY
                Jobs.id
        ...
        ALL (
            ...
            FROM
                ...
                LEFT JOIN affiliates RecQualifications ON (
                    RecQualifications.id = (JobsRecQualifications.affiliate_id)
        ...
        ALL (
            ...
            FROM
                ...
                LEFT JOIN affiliates ReqQualifications ON (
                    ReqQualifications.id = (JobsReqQualifications.affiliate_id)
...
GROUP BY
    tmp_jobs.Jobs__id
ORDER BY
    tmp_jobs.Jobs__sort_order desc,
    tmp_jobs.Jobs__id DESC
LIMIT
    50 OFFSET 0